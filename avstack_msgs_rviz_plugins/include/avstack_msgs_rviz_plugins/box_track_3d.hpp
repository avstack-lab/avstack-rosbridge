...
#ifndef AVSTACK_MSGS_RVIZ_PLUGINS__BOX_TRACK_3D_HPP_
#define AVSTACK_MSGS_RVIZ_PLUGINS__BOX_TRACK_3D_HPP_
...
class BoxTrack3DDisplay
  : public BoxTrack3DCommon<avstack_msgs::msg::BoxTrack3D>
{
  Q_OBJECT
...
public:
  ...
  BOX_TRACK_3D_DISPLAY_HPP_PUBLIC
  BoxTrack3DDisplay();
  BOX_TRACK_3D_DISPLAY_HPP_PUBLIC
  ~BoxTrack3DDisplay();
  BOX_TRACK_3D_DISPLAY_HPP_PUBLIC
...
private:
  ...
  void processMessage(BoxTrack3D::ConstSharedPtr msg) override;
  BoxTrack3D::ConstSharedPtr latest_msg;
...
#endif  // AVSTACK_MSGS_RVIZ_PLUGINS__BOX_TRACK_3D_HPP_